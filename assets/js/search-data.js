...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Repositories",
          description: "Coursework and for fun repositories",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%6F%72%64%69%61%6C%74%61%72%65%6A%6F%73@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/jordialt", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/jordi-altarejos-bono", "_blank");
        },
      },{
      id: 'light-theme',
